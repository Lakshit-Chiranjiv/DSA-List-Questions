...
public class Q29 {
    ...
    // length of string - length of longest palindromic subsequence is the answer
    ...
    public static int min_insertions(String s){
        int n = s.length();
    ...
    public static int min_insertions_memo(String s){
        int n = s.length();
        int lps = longest_palindromic_subsequence_memo(s);
        return n - lps;
    }
    ...
    public static int min_insertions_tab(String s){
        int n = s.length();
        int lps = longest_palindromic_subsequence_tab(s);
        return n - lps;
    }
    ...
    public static int min_insertions_tab_opt(String s){
        int n = s.length();
        int lps = longest_palindromic_subsequence_tab_opt(s);
        return n - lps;
    }

    public static void main(String[] args) {
        String s = "geeks";
        System.out.println(min_insertions(s));
        System.out.println(min_insertions_memo(s));
        System.out.println(min_insertions_tab(s));
        System.out.println(min_insertions_tab_opt(s));
    }
}
